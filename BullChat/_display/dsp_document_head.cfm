...
<!--- 		<link rel="stylesheet" href="styles/adminica/all.css"> --->
		...
		layout_switcher.html	: layout - fluid by default.								(eg. styles/themes/layout_switcher.html?default=layout_fixed.css)
		nav_switcher.html	: header and sidebar nav  positioning - sidebar by default.	(eg. styles/themes/nav_switcher.html?default=header_top.css)
		skin_switcher.html 	: Adminica skin - dark by default.							(eg. styles/themes/skin_switcher.html?default=theme_light.css)
		theme_switcher.html 	: colour theme - black/grey by default.						(eg. styles/themes/theme_switcher.html?default=theme_red.css)
		bg_switcher.html 	: background image - dark boxes by default.					(eg. styles/themes/bg_switcher.html?default=bg_honeycomb.css)	-->

<!--- 		<link rel="stylesheet" href="styles/themes/layout_switcher.html?default=layout_fixed.css" >
		<link rel="stylesheet" href="styles/themes/nav_switcher.html?default=nav_top.css" >
		<link rel="stylesheet" href="styles/themes/skin_switcher.html?default=switcher.css" >
		<link rel="stylesheet" href="styles/themes/theme_switcher.html?default=theme_blue.css" >
		<link rel="stylesheet" href="styles/themes/bg_switcher.html?default=bg_honeycomb.css" > --->
